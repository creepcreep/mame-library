...
//                      fraction:1.0];
	...
	NSBezierPath *path = [NSBezierPath bezierPathWithRect:NSMakeRect(0,34,[bg size].width,[self frame].size.height-22-34)];
	
//	NSRect lineRect = NSMakeRect(0,2,[bg size].width,[self frame].size.height-24);
//	NSRect frame = [self frame];
//	
//	NSLog(@"lineRect: %f,%f,%f,%f",lineRect.origin.x,lineRect.origin.y,lineRect.size.width,lineRect.size.height);
